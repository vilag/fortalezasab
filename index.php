...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Fortaleza de la sabiduria | Casa de descanso</title>


    <!-- ===============================================-->
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="images/logo/logo_web.png">
    <link rel="icon" type="image/png" sizes="32x32" href="images/logo/logo_web.png">
    <link rel="icon" type="image/png" sizes="16x16" href="images/logo/logo_web.png">
    <link rel="shortcut icon" type="image/x-icon" href="images/logo/logo_web.png">
    <link rel="manifest" href="assets/img/favicons/manifest.json">
    <meta name="msapplication-TileImage" content="images/logo/logo_web.png">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-DGMRSBQY1T"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-DGMRSBQY1T');
    </script>
  ...
  <body>
    ...
    <script>
      ...
      chatbox.setAttribute("page_id", "104243448815431");
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" >
        <div class="container"><a class="navbar-brand" href="index.php"><img src="https://res.cloudinary.com/ddcszcshl/image/upload/v1644820753/Casa%20de%20Retiro/Logo_web_je0knv.png" alt="logo" style="position: absolute; width: 260px;" /></a>
      ...
      <section class="py-xxl-10 pb-0" id="home">
        ...
        <div class="container">
          <div class="row min-vh-xl-100 min-vh-xxl-25">
            <div class="col-md-5 col-xl-6 col-xxl-7 order-0 order-md-1 text-end"><img class="pt-7 pt-md-0 w-100" src="images/imagenes/foto3.png" alt="hero-header" /></div>
      ...
      <!--<section class="py-xxl-10 pb-0" id="home" style="padding-left: 50px;">
        <div class="bg-holder bg-size" style="background-image:url(assets/img/gallery/hero-bg.png);background-position:top center;background-size:cover;">
        </div>
        ...
        <div class="container">
          <div class="row min-vh-xl-100 min-vh-xxl-25">
            <div class="col-md-5 col-xl-6 col-xxl-7 order-0 order-md-1 text-end"><img class="pt-7 pt-md-0 w-100" src="images/imagenes/foto3.png" alt="hero-header" style="width: 400px !important; margin-top: 50px;" />
              <h1 class="fw-light font-base fs-6 fs-xxl-7">Casa de  <strong>Retiro </strong>para<br><strong>Adultos Mayores.</strong></h1>
              <p class="fs-1 mb-5">Somos una Institución especializada en el cuidado y atención para personas de la tercera edad. </p>
            </div>
            <div class="col-md-75 col-xl-6 col-xxl-5 text-md-start text-center py-6" style="background-color: white; height: 600px; width: 450px; margin-top: 50px; margin-right: 30px; margin-left: 30px; padding: 40px; border-radius: 20px;">

                <form class="row g-3">

                  <div class="col-md-12" style="margin-top: -10px;">                   
                    <b style="font-size: 21px;">Nos gustaria solucionar todas tus dudas, escribenos y con gusto te ayudaremos</b>   
                  </div>
                  <div class="col-md-12" style="margin-top: 30px;">
                    <label style="font-size: 15px;">* Por favor ayudanos capturando los campos requeridos</label> 
                  </div>
                  <div class="col-md-12" style="margin-top: 20px;">
                    <label class="visually-hidden" for="inputName">Name</label>
                    <input class="form-control form-livedoc-control" id="inputName" type="text" placeholder="Name" style="border-style: solid; border-color: rgba(0, 0, 0, 0.3); height: 45px; border-radius: 15px !important;" />
                  </div>
                  <div class="col-md-12">
                    <label class="visually-hidden" for="inputPhone">Phone</label>
                    <input class="form-control form-livedoc-control" id="inputPhone" type="text" placeholder="Phone" style="border-style: solid; border-color: rgba(0, 0, 0, 0.3); height: 45px; border-radius: 15px !important;"/>
                  </div>
                  
                  <div class="col-md-12">
                    <label class="form-label visually-hidden" for="inputEmail">Email</label>
                    <input class="form-control form-livedoc-control" id="inputEmail" type="email" placeholder="Email" style="border-style: solid; border-color: rgba(0, 0, 0, 0.3); height: 45px; border-radius: 15px !important;"/>
                  </div>
                  <div class="col-md-12">
                    <label class="form-label visually-hidden" for="validationTextarea">Message</label>
                    <textarea class="form-control form-livedoc-control" id="validationTextarea" placeholder="Message" style="height: 140px; border-style: solid; border-color: rgba(0, 0, 0, 0.3); border-radius: 15px !important;" required="required"></textarea>
                  </div>
                  <div class="col-12">
                    <div class="d-grid">
      ...
      <!-- ============================================-->
      <!-- <section> begin ============================-->
      <section class="py-5" id="departments" style="">
      ...
      <section class="bg-secondary">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 col-xxl-6"><img class="img-fluid" src="images/imagenes/medical-exam.jpg" alt="..." /></div>
            <div class="col-md-7 col-xxl-6 text-center text-md-start">
              <h2 class="fw-bold text-light mb-4 mt-4 mt-lg-0">Valoración medica semanal</h2>
              <p class="text-light">Tiene la finalidad de monitorear la exposición a factores de riesgo e identificar en forma anticipada, posibles alteraciones temporales, permanentes o agravadas del estado de salud de nuestros residentes.</p>
      ...
      <section class="py-5">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 order-lg-1 mb-5 mb-lg-0"><img class="fit-cover rounded-circle w-100" src="images/imagenes/rehabilitacion_fisica.jpg" alt="..." style="height: 400px !important;" /></div>
            <div class="col-md-6 text-center text-md-start">
              <h2 class="fw-bold mb-4">Rehabilitación Física</h2>
              <p>Es el cuidado que usted recibe para recuperar, mantener o mejorar las capacidades que necesita para la vida diaria. Estas capacidades pueden ser físicas, mentales y/o cognitivas.</p>
              <div class="py-3">
      ...
      <section class="bg-secondary">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 col-xxl-6"><img class="img-fluid" src="images/imagenes/nutricion.jpg" alt="..." /></div>
            <div class="col-md-7 col-xxl-6 text-center text-md-start">
              <h2 class="fw-bold text-light mb-4 mt-4 mt-lg-0">Nutriología</h2>
              <p class="text-light"> Proporcionar una variedad de alimentos que brinden los nutrientes que necesite cada residente, para mantenerse sano, sentirse bien y tener energía.</p>
              <!--<div class="py-3"><a class="btn btn-lg btn-light rounded-pill" href="#!" role="button">Learn more </a></div>-->
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 py-3">
              ...
              <h1 class="text-center">CULTURA ORGANIZACIONAL</h1>
            </div>
          </div>
        </div>
      ...
      <section class="py-8">
        ...
        <div class="container" style="height: 550px;" id="div_cultura">
                ...
                <div class="carousel-item active" data-bs-interval="10000">
                  <div class="row h-100">
                    ...
                    <div class="col-sm-9 text-center text-sm-start pt-3 pt-sm-0">
                      ...
                      <p>Como Casa de Retiro para Adultos Mayores nuestra misión es brindar un espacio cálido y familiar, donde las personas de la tercera edad se sientan en un ambiente confiable y seguro, nuestro cometido es ofrecer servicios personalizados y de calidad, siempre cuidando su integridad fisica y emocional.</p>
                    </div>
                    <div class="col-sm-9 text-center text-sm-start pt-3 pt-sm-0">
                      <h2>Visión</h2>
                      <!--<div class="my-2"><i class="fas fa-star me-2"></i><i class="fas fa-star me-2"></i><i class="fas fa-star me-2"></i><i class="fas fa-star-half-alt me-2"></i><i class="far fa-star"></i></div>-->
                      <p>Ser una Casa de Retiro para Adultos reconocida por los cuidados integrales que se les ofrece a nuestros residentes.</p>
                    </div>
                    <div class="col-sm-9 text-center text-sm-start pt-3 pt-sm-0">
                      <h2>Filosofía</h2>
                      <!--<div class="my-2"><i class="fas fa-star me-2"></i><i class="fas fa-star me-2"></i><i class="fas fa-star me-2"></i><i class="fas fa-star-half-alt me-2"></i><i class="far fa-star"></i></div>-->
                      <p>En "Fortaleza de la Sabiduria" queremos ser reconocidos por la calidad en nuestros servicios y nuestra excelencia en la  atención de Adultos Mayores, así que nos esforzaremos para poder alcanzar las expectativas de nuestros residentes y sus familiares.</p>
                    </div>
                  </div>
                </div>
          ...
          <div class="row py-5 align-items-center justify-content-center justify-content-lg-evenly">
            <div class="col-auto col-md-4 col-lg-auto text-xl-start">
              <div class="d-flex flex-column align-items-center">
                <div class="icon-box text-center"><img class="mb-3 deparment-icon" src="images/iconos/respeto.png" style="width: 100px;" alt="..." />
             ...
             <div class="col-auto col-md-4 col-lg-auto text-xl-start">
              <div class="d-flex flex-column align-items-center">
                <div class="icon-box text-center"><a class="text-decoration-none" href="#!"><img class="mb-3 deparment-icon" src="assets/img/icons/osteoporosis.png" alt="..." /><img class="mb-3 deparment-icon-hover" src="assets/img/icons/osteoporosis.svg" alt="..." />
                    <p class="fs-1 fs-xxl-2 text-center">Responsabilidad</p>
                  </a></div>
              </div>
            </div>
            <div class="col-auto col-md-4 col-lg-auto text-xl-start">
              <div class="d-flex flex-column align-items-center">
                <div class="icon-box text-center"><a class="text-decoration-none" href="#!"><img class="mb-3 deparment-icon" src="assets/img/icons/eye-care.png" alt="..." /><img class="mb-3 deparment-icon-hover" src="assets/img/icons/eye-care.svg" alt="..." />
                    <p class="fs-1 fs-xxl-2 text-center">Confidencialidad</p>
                  </a></div>
              </div>
            </div>
            <div class="col-auto col-md-4 col-lg-auto text-xl-start">
            ...
            <div class="col-auto col-md-4 col-lg-auto text-xl-start">
              <div class="d-flex flex-column align-items-center">
                <div class="icon-box text-center"><a class="text-decoration-none" href="#!"><img class="mb-3 deparment-icon" src="assets/img/icons/heart.png" alt="..." /><img class="mb-3 deparment-icon-hover" src="assets/img/icons/heart.svg" alt="..." />
                    <p class="fs-1 fs-xxl-2 text-center">Profesionalismo</p>
                  </a></div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-6 col-lg-3 mb-4">
              <div class="card h-100 shadow card-span rounded-3" style="height: 320px !important;"><img class="card-img-top rounded-top-3" src="images/imagenes/1.png" alt="news" />
                <div class="card-body" align="center" style="position: absolute; background-color: rgba(255, 255, 255, 0.5); width: 100%; bottom: 0;">
                  
                  <h5 class="font-base fs-lg-0 fs-xl-1 my-3" style="font-size: 22px !important;">Respeto</h5>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-lg-3 mb-4">
              <div class="card h-100 shadow card-span rounded-3" style="height: 320px !important;"><img class="card-img-top rounded-top-3" src="images/imagenes/2.png" alt="news" />
                <div class="card-body" align="center" style="position: absolute; background-color: rgba(255, 255, 255, 0.5); width: 100%; bottom: 0;">
                  
                  <h5 class="font-base fs-lg-0 fs-xl-1 my-3" style="font-size: 22px !important;">Responsabilidad</h5>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-lg-3 mb-4">
              <div class="card h-100 shadow card-span rounded-3" style="height: 320px !important;"><img class="card-img-top rounded-top-3" src="images/imagenes/3.png" alt="news" />
                <div class="card-body" align="center" style="position: absolute; background-color: rgba(255, 255, 255, 0.5); width: 100%; bottom: 0;">
                  
                  <h5 class="font-base fs-lg-0 fs-xl-1 my-3" style="font-size: 22px !important;">Confidencialidad</h5>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-lg-3 mb-4">
              <div class="card h-100 shadow card-span rounded-3" style="height: 320px !important;"><img class="card-img-top rounded-top-3" src="images/imagenes/4.png" alt="news" />
                <div class="card-body" align="center" style="position: absolute; background-color: rgba(255, 255, 255, 0.5); width: 100%; bottom: 0;">
                  
                  <h5 class="font-base fs-lg-0 fs-xl-1 my-3" style="font-size: 22px !important;">Profesionalismo</h5>
                </div>
              </div>
            </div>
      ...
      <section class="py-0 bg-secondary">
        ...
        <!--<div class="container">
          <div class="row py-8">
            <div class="col-12 col-sm-12 col-lg-6 mb-4 order-0 order-sm-0"><a class="text-decoration-none" href="#"><img src="images/logo/logo_1.png" height="200" alt="" /></a>
             
            </div>
            <div class="col-6 col-sm-4 col-lg-2 mb-3 order-2 order-sm-1" style="">
              <h5 class="lh-lg fw-bold mb-4 text-light font-sans-serif">Servicios</h5>
              <ul class="list-unstyled mb-md-4 mb-lg-0">
                <li class="lh-lg"><a class="footer-link" href="#!">Valoración Medica</a></li>
                <li class="lh-lg"><a class="footer-link" href="#!">Rehabilitación Física</a></li>
                <li class="lh-lg"><a class="footer-link" href="#!">Nutriología</a></li>
              </ul>
            </div>
            <div class="col-6 col-sm-4 col-lg-2 mb-3 order-3 order-sm-2">
              <h5 class="lh-lg fw-bold text-light mb-4 font-sans-serif">Rehabilitación Física</h5>
              <ul class="list-unstyled mb-md-4 mb-lg-0">
            ...
            <div class="col-6 col-sm-4 col-lg-2 mb-3 order-3 order-sm-2">
              <h5 class="lh-lg fw-bold text-light mb-4 font-sans-serif">Nutriología</h5>
              <ul class="list-unstyled mb-md-4 mb-lg-0">
        ...
        <section class="py-0 bg-primary">
          ...
          <div class="container">
            <div class="row justify-content-md-between justify-content-evenly py-4">
              <div class="col-12 col-sm-8 col-md-6 col-lg-auto text-center text-md-start">
                <p class="fs--1 my-2 fw-bold text-200">All rights Reserved &copy; Fortaleza de la Sabiduria, 2022</p>
              </div>
